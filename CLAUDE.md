...
>
> **Módulo 3 (Pagos) owes exactly one thing: the equipment-sales sub-section.** Start at `docs/sistema-gestion-plan.md` §6d.
...
cd apps/platform && npm test          # vitest, 217 cases, no backend needed
