...
>
> **The one thing still worth carrying forward:** **two business rules live in a document rather than in the code** — the deposit and the reservation hour order. Both are written up in `platform.md` §5, and both belong to Módulo 2: they need screens that don't exist yet.
>
> **Módulo 1 closed on 2026-08-16, and Módulo 2's backend with it. What's next is the calendar grid — the largest front-end piece in the project and the plan's #1 risk.** Start at `docs/sistema-gestion-plan.md` §6d.
...
cd apps/platform && npm test          # vitest, 87 cases, no backend needed
