...
>
> **Módulo 1 closed on 2026-08-16. What's next is Módulo 2 (Horarios y salas), and the deposit migration goes with its start — not before.** Start at `docs/sistema-gestion-plan.md` §6d.
