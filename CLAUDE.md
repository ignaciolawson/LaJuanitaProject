...
>
> **Two things still worth knowing:** the CI pipeline's four steps were verified locally and **nobody has confirmed a green run on Actions**; and **two business rules live in a document rather than in the code** — the deposit and the reservation hour order. Both are written up in `platform.md` §5 and both belong to Módulo 2.
