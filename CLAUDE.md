...
**Database rule tests** — 184 cases (134 business-rule + 50 adversarial) covering every
...
Postgres service — which also proves the eleven migrations apply to an empty database, the
