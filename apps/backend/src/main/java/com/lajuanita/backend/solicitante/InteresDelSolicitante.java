...
public enum InteresDelSolicitante {
    ...
    /**
     * Anotarse a un programa — DJ, Producción o la mentoría. Cuál, lo dice
     * {@code Solicitante#disciplina} desde {@code V29} (antes viajaba escrito en
     * {@code detalle}); las tres están en {@code inscripcion_disciplina_valida}
     * desde {@code V1}. (Decía "DJ o Producción" hasta §16 · A7, cuando la
     * landing sumó la mentoría que el sistema ya inscribía.)
     */
    CURSO,
